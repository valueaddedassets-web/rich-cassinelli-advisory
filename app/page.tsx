    ...
    <main>
      ...
      <header className="nav shell">
        <a className="brand" href="#top" aria-label="Rich Cassinelli Advisory home">
          ...
          <span><strong>RICH CASSINELLI</strong><small>VALUE ADDED ASSETS LLC</small></span>
        </a>
      ...
      <section className="hero" id="top">
        <div className="shell heroGrid">
          <div className="heroCopy">
            <p className="eyebrow">A Value Added Assets LLC company</p>
      ...
      <section className="section shell" id="services">
        <div className="sectionIntro"><p className="eyebrow">Two paths to recovered value</p><h2>Turn technical complexity into a clear next move.</h2><p>As part of Value Added Assets LLC, Rich is your first call and ongoing consultant—identifying the right questions, connecting you with qualified specialists, and helping keep the process coordinated.</p></div>
      ...
      <footer><div className="shell footerGrid"><div className="brand footerBrand"><span className="brandMark"><img src="/cassinelli-mark.png" alt="" /></span><span><strong>RICH CASSINELLI</strong><small>VALUE ADDED ASSETS LLC</small></span></div><p>Part of Value Added Assets LLC—connecting owners and importers with experienced cost segregation and tariff recovery professionals.</p><div><a href="mailto:rich@cassval.com">rich@cassval.com</a><a href="tel:+15035455217">(503) 545-5217</a></div></div><div className="shell legal">© 2026 Value Added Assets LLC. All rights reserved.<span>Information is educational only and is not tax, legal, engineering, customs, or investment advice. Results are not guaranteed.</span></div></footer>
    </main>
  );
}
